...
router.get('/render_sum_specs', users.sumSpecs)
router.get('/render_zip_sum_specs', users.zipSumSpecs)
router.get('/render_zip_price_specs', users.zipPriceSpecs)
router.get('/render_zip_count_specs', users.zipCountSpecs)
router.get('/render_count_specs', users.countSpecs)
router.get('/render_price_specs', users.priceSpecs)
router.get('/do_excel_specs', users.doExcelZipSpecs)
router.get('/do_excel_specs_only', users.doExcelSpecs)
